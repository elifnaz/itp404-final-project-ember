...
define('itpfin/blueprints/surge', ['exports', 'ember-cli-surge/blueprints/surge'], function (exports, _emberCliSurgeBlueprintsSurge) {
...
define('itpfin/router', ['exports', 'ember', 'itpfin/config/environment'], function (exports, _ember, _itpfinConfigEnvironment) {
  ...
  Router.map(function () {
    this.route('search', function () {
      this.route('results', { path: ':term/:location' });
    });
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("Must Eats");
        dom.appendChild(el2, el3);
        dom.appendChild(el1, el2);
        dom.appendChild(el0, el1);
        var el1 = dom.createTextNode("\n");
...
define('itpfin/tests/mirage/mirage/factories/restaurant.jshint', ['exports'], function (exports) {
  QUnit.module('JSHint | mirage/factories/restaurant.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mirage/factories/restaurant.js should pass jshint.');
  });
});
define('itpfin/tests/mirage/mirage/models/restaurant.jshint', ['exports'], function (exports) {
  QUnit.module('JSHint | mirage/models/restaurant.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'mirage/models/restaurant.js should pass jshint.');
  });
});
...
if (!runningTests) {
  require("itpfin/app")["default"].create({"apiEndpoint":"http://localhost:3000","name":"itpfin","version":"0.0.0+c061958f"});
}
