...
define('itpfin/routes/list/new', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "restaurant.name", ["loc", [null, [5, 4], [5, 23]]], 0, 0, 0, 0], ["content", "restaurant.city", ["loc", [null, [5, 25], [5, 44]]], 0, 0, 0, 0]],
        locals: ["restaurant"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["content", "outlet", ["loc", [null, [1, 0], [1, 10]]], 0, 0, 0, 0], ["block", "each", [["get", "model.restaurants", ["loc", [null, [3, 10], [3, 27]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [3, 2], [7, 11]]]]],
      locals: [],
      templates: [child0]
    };
  })());
});
define("itpfin/templates/list/new", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      meta: {
        "revision": "Ember@2.8.3",
      ...
      statements: [["content", "outlet", ["loc", [null, [1, 0], [1, 10]]], 0, 0, 0, 0], ["inline", "input", [], ["value", ["subexpr", "@mut", [["get", "name", ["loc", [null, [3, 20], [3, 24]]], 0, 0, 0, 0]], [], [], 0, 0], "type", "text", "id", "name"], ["loc", [null, [3, 6], [3, 48]]], 0, 0], ["inline", "input", [], ["value", ["subexpr", "@mut", [["get", "author", ["loc", [null, [4, 20], [4, 26]]], 0, 0, 0, 0]], [], [], 0, 0], "type", "text", "id", "city"], ["loc", [null, [4, 6], [4, 50]]], 0, 0], ["element", "action", ["addRestaurant"], [], ["loc", [null, [5, 45], [5, 71]]], 0, 0]],
      locals: [],
      templates: []
    };
  })());
...
if (!runningTests) {
  require("itpfin/app")["default"].create({"name":"itpfin","version":"0.0.0+1bd5e563"});
}
