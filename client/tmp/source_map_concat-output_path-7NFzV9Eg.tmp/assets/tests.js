...
define('itpfin/tests/routes/list/new.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | routes/list/new.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/list/new.js should pass jshint.');
  });
});
...
define('itpfin/tests/unit/controllers/list/new-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('controller:list/new', 'Unit | Controller | list/new', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('itpfin/tests/unit/controllers/list/new-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/controllers/list/new-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/controllers/list/new-test.js should pass jshint.');
  });
});
...
define('itpfin/tests/unit/routes/list/new-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {

  (0, _emberQunit.moduleFor)('route:list/new', 'Unit | Route | list/new', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('itpfin/tests/unit/routes/list/new-test.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | unit/routes/list/new-test.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/list/new-test.js should pass jshint.');
  });
});
