...
define("itpfin/templates/components/restaurant-item", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      statements: [["content", "restaurant.name", ["loc", [null, [3, 36], [3, 55]]], 0, 0, 0, 0], ["block", "if", [["get", "isPopular", ["loc", [null, [4, 15], [4, 24]]], 0, 0, 0, 0]], [], 0, null, ["loc", [null, [4, 9], [6, 13]]]], ["content", "restaurant.review_count", ["loc", [null, [8, 6], [8, 33]]], 0, 0, 0, 0], ["attribute", "src", ["get", "restaurant.rating_img_url_small", ["loc", [null, [9, 31], [9, 62]]], 0, 0, 0, 0], 0, 0, 0, 0], ["content", "restaurant.location.address", ["loc", [null, [13, 6], [13, 37]]], 0, 0, 0, 0], ["content", "restaurant.location.state_code", ["loc", [null, [13, 39], [13, 73]]], 0, 0, 0, 0], ["attribute", "onClick", ["subexpr", "action", ["addToList"], [], ["loc", [null, [null, null], [15, 101]]], 0, 0], 0, 0, 0, 0]],
      locals: [],
      templates: [child0]
    };
  })());
...
if (!runningTests) {
  require("itpfin/app")["default"].create({"apiEndpoint":"http://localhost:3000","name":"itpfin","version":"0.0.0+96716c25"});
}
